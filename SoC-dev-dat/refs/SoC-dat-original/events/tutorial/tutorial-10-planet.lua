...
In this tutorial you will learn about what you can expect on a planet or station once you land on it. We'll start by landing on Eden. Landing is covered in another tutorial, so for now we'll land automatically.]]
...
To access the more interesting facilities on Eden, you will need to click on the tabs at the bottom of the planet menu. Each tab represents a different area of the spaceport. Some spaceports may not have all of the facilities you see here, and the things on offer will vary from planet to planet. Sometimes you will have to fly to another planet to get what you need.
...
function create()
	 ...
	 player.teleport("Eden")
	 player.pilot():setPos(planet.get("Eden"):pos())
	 player.msgClear()
	 ...
	 player.pilot():land(planet.get("Eden"))
