...
function create()
	 ...
	 pp = player.pilot()
	 pp:setPos(planet.get("Sanctuary"):pos() + vec2.new(0, 250))
	 player.msgClear()
	 
	 pilot.clear()
	 pilot.toggleSpawn(false)
	 commdrone = pilot.add("Irali", "dummy", pp:pos() + vec2.new(0, 250))[1]
...
function haildrone()
	 ...
	 commship = pilot.add("Akk'Ti'Makkt", "dummy", planet.get("Sanctuary"))[1]
