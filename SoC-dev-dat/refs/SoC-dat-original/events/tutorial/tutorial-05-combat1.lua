...
Combat is an important aspect of Naev, and you will have to fight off enemies sooner or later, no matter what career you decide to pursue. In this tutorial, you will learn the basic principles of combat.]]
	message2 = [[For this tutorial, you will be flying a T'Telin fighter. It comes equipped with four laser cannons. You can fire your weapons by pressing %s. Try this now.]]
...
Your ship also comes equipped with a Railgun, which is treated as a secondary weapon by default.  Fire it now using %s and watch its ammunition deplete.]]
...
Congratulations! This concludes the basic combat tutorial.]]
	...
	shield30 = {
		...
		"Did you know T. stands for Tiberius in my name?",
		...
		"Karnil Fried Chicken. Eat only the best, raised on genuine Naïmsh proteins flour.",
...
function create()
	-- Set up the player on a near-empty system.
	player.teleport("Wo 9615")
	pilot.clear()
	...
	-- Reconfigure the player's ship with 2 primary lasers, 2 secondary railguns and no missiles
	-- Note : you need to give first the Railguns, then the Lasers, I don't know why...
	pp:rmOutfit("all")
	pp:addOutfit("Fighter Railgun Cannon", 2)
	pp:addOutfit("Fighter Laser Cannon", 2)

	-- Display the player's outfits
	for i,j in pairs(player.pilot():outfits()) do
...
function dummypractice()
	drone = pilot.add("Angry Bee Drone", "dummy", pp:pos() + vec2.new(200, 0))[1]
...
function captainpractice()
	...
	captainTP = pilot.add("Nelk'Tan", "baddie_norun")[1]
