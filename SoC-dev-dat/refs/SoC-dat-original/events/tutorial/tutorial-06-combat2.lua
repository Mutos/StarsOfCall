...
Guided missile weapons behave differently from other weapons. This tutorial explains the basic mechanics and teaches you how to handle such weapons.]]
	message2 = [[You are currently equipped with a Small Interception Missiles launcher. These missiles are low-end interceptor missiles that excel at chasing down agile targets such as light fighters.
...
You have been given two fully loaded SIM launchers. Engage Captain T. Practice with them. Notice how the missiles will actively seek out the target. It's possible to avoid guided missiles, even the fast Fury missiles, but it's not easy to do.]]
...
function create()
	...
	pp:setDir(120)
	player.swapShip("Akk'Ti'Makkt", "Akk'Ti'Makkt", "Earth", true, true)
	pp:rmOutfit("all")
	pp:addOutfit("SIM Launcher", 2)
	player.msgClear()
