...
--[[
	...
	Shoden raider AI : raider with parameters
...
tabOffenseTaunts = {
	...
	"We Shoden just take back what is ours!",
	"Sorry, you just happen to own Sshaad property!",
}
tabNoOffenseTaunts = {
	"You dare attack me?!",
	...
	"Hail to True Sshaads!",
	"Thhhhink you can beat a True Sshaad?",
}
