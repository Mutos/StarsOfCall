...
local bribe_no_list = {
   ...
   _([["The Alliance can't be lenient on scum like you."]]),
...
local taunt_list_offensive = {
   ...
   _("The Alliance will enjoy your capture!"),
   _("Your head will make a fine trophy for the Admiralty!"),
   _("None survive the wrath of the Alliance Navy!"),
   _("Enjoy your last moments, criminal!")
}
local taunt_list_defensive = {
   _("You dare attack me?!"),
   _("You are no match for the Alliance Navy!"),
   _("The Alliance will have your head!"),
...
function create ()
   ...
   if r == 0 then
      p:broadcast(_("The Alliance is watching you."))
   elseif r == 1 then
...
function hail ()
   ...
   if standing < 0 then
      mem.refuel_no = _([["My fuel is property of the Alliance Navy."]])
